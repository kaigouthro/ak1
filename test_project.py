...
class TestProject(unittest.TestCase):
    ...
    def test_add_task_variable(self):
        ...
        self.assertEqual(self.project_assistant.task_variables['task1']['variable1'], 'value1')
    ...
    def test_fill_template_and_add_task(self):
        self.project_assistant.fill_template_and_add_task('task1', 'description ${variable}', {'variable': 'value'})
        self.assertIn('task1', self.project_assistant.task_variables)

    def test_execute_tasks_based_on_dependencies(self):
        self.project_assistant.add_task('task1', 'description1')
        self.project_assistant.add_task('task2', 'description2', dependencies=[self.project_assistant.tasks[0][1]])
